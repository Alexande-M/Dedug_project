...
class Project(models.Model):
    ...
    # Стоимость проекта 
    project_cost = models.PositiveIntegerField("Стоимость проекта",  help_text = "Указывать сумму в рублях",default=0)
    
    # Сумма инвестиции 
    project_investment  = models.PositiveIntegerField("Сумма инвестиции",  help_text = "Указывать сумму в рублях", blank=True,default=0)
    ...
    #Число просмотров 
    count_views_project = models.PositiveIntegerField('Число просмотров', blank = True, default=0)
