$(function () {
	...
	let notifications = $('.notification__block')

	$('.notification__img').on('click', function () {
		notifications.slideToggle();
	});

	$('.delete__notification').on('click', function () {
		let notification = $(this).parents('.notification__block-item');
	...
	$('.component__list input').on('click', function () {
		$(this).parent('label').toggleClass('bold');
	});
