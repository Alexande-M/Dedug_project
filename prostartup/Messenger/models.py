...
class Chat(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Messenger:messages', args=[self.pk])
...
class SettingsChat(models.Model):
    chat = models.ForeignKey(Chat, verbose_name =_("Настройки сообщений"), on_delete=models.CASCADE)
    user = models.ForeignKey(User, verbose_name=_("Пользователь"),on_delete=models.CASCADE, default="")
