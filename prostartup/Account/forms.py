...
class UpgradeProjectForm(forms.ModelForm):
    class Meta:
        model = Project
        fields = ('project_name','project_cost','presentation','project_img_one','project_img_two','project_img_three', 'project_investment',)
        widgets = {
...
class ProfileEditForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'photo': forms.FileInput(attrs={'type': 'file', 'id' : 'profile-image', 'accept' : 'image/*'}),
        }
